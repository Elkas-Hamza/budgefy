...
Create Category With General Icon
    ...
    Create Category    General Cat 22-05-2026-10    blue    general
...
Create Category With Travel Icon
    ...
    Create Category    Travel Cat 22-05-2026-11    green    travel
...
Create Category
    ...
    # ICONS (FIXED SYNTAX)
    Run Keyword If    '${icon_type}' == 'general'    Select From List By Value    ${icon_select}    label
    Run Keyword If    '${icon_type}' == 'travel'     Select From List By Value    ${icon_select}    travel
